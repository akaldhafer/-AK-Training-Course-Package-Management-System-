...
//project title:  AK Training Course Package Management System  
//powered by: ABDULMALEK ALDHAFER
...
void SystemMenu() {
	system("cls");
	printf("\n##--------------------------------------------------------------##\n");
	printf("\n            AK Training Course Package Management System           \n");
	printf("\n##--------------------------------------------------------------##\n\n");
...
int main() {
	...
	for (int i = 0; i < 10; i++)
	{
		Beep(2000, 400); /* function to make sound while the system is analyzing the data*/
		printf("|||");
	}
	printf("\n\n                         << Done >>\n\n");
	system("pause");
